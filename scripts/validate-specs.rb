...
errors << "Agent installer must configure remote MCP clients by default and retain an explicit opt-out" unless agent_installer_source.include?("--no-configure-global-clients") && agent_installer_source.include?("CONFIGURE_GLOBAL_CLIENTS=true")
