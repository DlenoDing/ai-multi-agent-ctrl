...
AIMAC_POSTGRES_PORT_VALUE="$(value_or_existing_or_default AIMAC_POSTGRES_PORT 55432)"
...
AIMAC_SYSTEM_ADMIN_NAME_VALUE="$(value_or_existing_or_default AIMAC_SYSTEM_ADMIN_NAME "系统管理员")"
...
AIMAC_LOCAL_SEED_ORG_ADMIN_TOKEN_VALUE="$(value_or_generated AIMAC_LOCAL_SEED_ORG_ADMIN_TOKEN aimac-org-admin)"
...
AIMAC_POSTGRES_PORT=${AIMAC_POSTGRES_PORT_VALUE}
...
AIMAC_LOCAL_SEED_ORG_ADMIN_TOKEN=${AIMAC_LOCAL_SEED_ORG_ADMIN_TOKEN_VALUE}
