(function () {
  ...
  const catalog = {
    ...
    "org-agents": [pane("nodes", "共享运行节点", ["agent 节点"]), pane("register", "注册共享节点", ["注册组织 agent"]), pane("profiles", "组织角色档案", ["组织级 Agent 档案"]), pane("tokens", "加入令牌", ["加入令牌审计"]), pane("help", "接入与管理说明")],
    "proj-agents": [pane("nodes", "项目运行节点", ["项目 agent 节点"]), pane("register", "注册项目节点", ["注册项目节点"]), pane("profiles", "项目与共享档案", ["可调配 Agent 档案"]), pane("help", "接入与运行说明")],
