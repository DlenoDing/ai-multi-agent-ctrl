(function () {
  ...
  const catalog = {
    ...
    "proj-settings": [pane("repositories", "仓库与凭据", ["项目基础配置"]), pane("baseline", "基线资料", ["基线资料"]), pane("default-roles", "默认角色", ["项目默认角色"]), pane("skills", "Skill 定制", ["角色 Skill 定制"]), pane("system-rules", "系统规则", ["系统规则"]), pane("business-rules", "业务规则", ["业务规则"]), pane("help", "配置说明")],
