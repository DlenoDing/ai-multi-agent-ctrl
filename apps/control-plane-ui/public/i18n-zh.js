...
(function () {
  ...
  const dict = {
    ...
    work_item_not_found: "这个任务组里找不到该工作项：请确认 workItemId",
    agent_control_command_type_required: "给节点下命令必须说清是哪一条命令",
    work_item_title_required: "创建工作项必须填标题",
    ...
    confirmed: "已确认",
    orphaned: "已失去归属",
    all_required_work_closed: "还有工作项没有收口",
    ...
    work_assign: "指派工作项",
    work_item_plan_finalization_set: "标记工作项方案定稿",
