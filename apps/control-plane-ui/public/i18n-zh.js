...
(function () {
  ...
  const dict = {
    ...
    all_quality_gates_passed: "质量门禁全通过", 
    no_pending_permissions: "无待处理授权", 
    all_required_evidence_present: "证据齐备", 
    all_commands_terminal: "命令全终态", 
    all_contracts_compatible: "契约全兼容", 
    no_active_temp_grants: "无活跃临时授权", 
    runtime_issue_candidates_exported: "运行问题候选已导出", 
    no_blocking_derived_task_requests: "无阻塞派生任务", 
    no_pending_review_bundles: "无待处理评审包", 
    completion_readiness_clear: "完成就绪已清", 
    no_active_role_drift_blockers: "无活跃角色漂移阻塞",
    all_shared_definitions_active: "共享定义全生效", 
